<?php
	if (stristr($_SERVER['HTTP_REFERER'],"guaflix.66ghz.com") || 
    stristr($_SERVER['HTTP_REFERER'],"http://recolectorguaflix.66ghz.com/")|| 
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <style type="text/css" media="screen">html,body{padding:0;margin:0;height:100%}#apicodes-player{width:100%!important;height:100%!important;overflow:hidden;background-color:}</style>
	<style type="text/css">
	/*!
 * Anti-adblock v2.1.0
...
else echo 'ESTE LINK SOLO FUNCIONA  EN NUESTRA  WEB http://guaflix.66ghz.com/';
?>	